...
small_img_path  = os.path.join(test_images_dir, "NavMap_Grid_XY_DefaultGrid.png")
...
# Locate the image on screen
location = pyautogui.locateOnScreen(os.path.join(test_images_dir, "MapMenu_Grid.png"), confidence=0.85)
...
if location:
    ...
    # Locate the image on screen
    location = pyautogui.locateOnScreen(os.path.join(test_images_dir, "MapMenu_Grid_LatLon.png"), confidence=0.85)
    ...
    if location:
        ...
        # Wait for Nav Map with Latitude/Longitude Grid and user to observe
        time.sleep(3)

    else:
        out.write("Menu item 'MapMenu->Grid->LatLon' not found.\n")
        # Close the application and terminate execution
        app.close
        sys.exit()

else:
    out.write("Menu item 'MapMenu->Grid' not found.\n")
    # Close the application and terminate execution
    app.close
    sys.exit()
...
# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_Grid_LatLon.png")
...
if location:
    ...
    # Locate the image on screen
    location = pyautogui.locateOnScreen(os.path.join(test_images_dir, "MapMenu_Grid_XY.png"), confidence=0.85)
    ...
    if location:
        ...
        # Wait for Nav Map with X/Y Grid and user to observe
        time.sleep(3)

    else:
        out.write("Menu item 'MapMenu->Grid->XY' not found.\n")
        # Close the application and terminate execution
        app.close
        sys.exit()
...
# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_Grid_XY.png")
