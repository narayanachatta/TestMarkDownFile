...
(moved_x, moved_y) = move.move_cursor_to_map_xy(673, -336)

# Right click at the x/y coordinates
...
if location:
    ...
    print(f"Clicked at: {center}")
    # Locate the image on screen
    location = pyautogui.locateOnScreen(os.path.join(test_images_dir, "MapMenu_ReferenceLocations_SetReferenceUAV.png"), confidence=0.85)
    ...
    if location:
        ...
        out.write("Menu item 'MapMenu->ReferenceLocations->SetReferenceUAV' not found.\n")
        # Close the application and terminate execution
        app.close
        sys.exit()
...
small_img_path  = os.path.join(test_images_dir, "NavMap_SetReferenceUAV_First.png")
...
# Move the cursor to x/y coordinates
(moved_x, moved_y) = move.move_cursor_to_map_xy(-446, 796)
...
# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_SetReferenceUAV_Second.png")
