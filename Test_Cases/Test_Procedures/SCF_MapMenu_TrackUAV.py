...
(moved_x, moved_y) = move.move_cursor_to_map_xy(-2862, 781)
...
small_img_path  = os.path.join(test_images_dir, "NavMap_TrackUAV_Changed.png")
...
location = pyautogui.locateOnScreen(os.path.join(test_images_dir, "MapMenu_TrackUAV.png"), confidence=0.85)
...
if location:
    ...
    # Wait for UAV symbol to return at center and user to observe
    time.sleep(2)

else:
    out.write("Menu item 'MapMenu->TrackUAV' not found.\n")
    # Close the application and terminate execution
    app.close
    sys.exit()
...
# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_TrackUAV_Default.png")
...
# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_TrackUAV_NoChange.png")
