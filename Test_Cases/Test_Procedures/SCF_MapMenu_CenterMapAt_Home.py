...
(moved_x, moved_y) = move.move_cursor_to_map_xy(-2438, -605)

# Release the left mouse button
mouse.release(button='left', coords=(moved_x, moved_y))
...
small_img_path  = os.path.join(test_images_dir, "NavMap_HomeUAV_LocationChanged_1.png")
...
if location:
    ...
    # Locate the image on screen
    location = pyautogui.locateOnScreen(os.path.join(test_images_dir, "MapMenu_CenterMapAt_Home.png"), confidence=0.85)
    ...
    if location:
        ...
        out.write("Menu item 'MapMenu->CenterMapAt->Home' not found.\n")
        # Close the application and terminate execution
        app.close
        sys.exit()
...
# Move to the ending point
(moved_x, moved_y) = move.move_cursor_to_map_xy(-3008, 1511)
...
# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_HomeUAV_LocationChanged_2.png")
...
# Wait for the Nav Map to return default position
time.sleep(1)
