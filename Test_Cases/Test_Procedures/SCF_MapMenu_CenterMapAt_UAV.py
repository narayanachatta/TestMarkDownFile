...
(moved_x, moved_y) = move.move_cursor_to_map_xy(2437, 1825)
...
small_img_path  = os.path.join(test_images_dir, "NavMap_HomeUAV_LocationChanged_3.png")
...
# Move to the ending point
(moved_x, moved_y) = move.move_cursor_to_map_xy(-3000, -2000)
...
# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_HomeUAV_LocationChanged_4.png")
