...
location = pyautogui.locateOnScreen(os.path.join(test_images_dir, "MapMenu_ShowJammingStatus.png"), confidence=0.85)
...
if location:
    ...
    # Wait for Jamming Status label is displayed on Nav Map and user to observe
    time.sleep(2)

else:
    out.write("Menu item 'MapMenu->ShowJammingStatus' not found.")
...
small_img_path  = os.path.join(test_images_dir, "NavMap_Jamming_window.png")
...
if location:
    ...
    # Wait for Jamming Status label is disappeared on Nav Map and user to observe
    time.sleep(2)
...
# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_No_Jamming_window.png")
