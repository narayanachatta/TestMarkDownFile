...
# Perform click at a specific position
pyautogui.click()

# Release shift
keyboard.release('shift')

# Wait for Colour Window
time.sleep(1)
...
basic_colours_grid.click_input(coords=(114, 95))
...
# Get the required coordinates in list
xy_coords = [(-124, 1584), (512, 1489), (776, 1168), (893, 263), (1625, 73)]

# Draw line through above coordinates through for loop
for x, y in xy_coords:

    # Move to the desired point
    (moved_x, moved_y) = move.move_cursor_to_map_xy(x, y)
...
# Capture screenshot using PIL
img1 = ImageGrab.grab(bbox)
img1.save(os.path.join(original_img_folder, "SCFlight_Window_DrawLine_1.png"))

# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window_DrawLine_1.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_HotKeys_DrawLine_1.png")
...
# Get the required coordinates in list
xy_coords = [(307, 1095), (637, 482), (476, -73), (805, -518)]
...
# Capture screenshot using PIL
img1 = ImageGrab.grab(bbox)
img1.save(os.path.join(original_img_folder, "SCFlight_Window_DrawLine_2.png"))

# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window_DrawLine_2.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_HotKeys_DrawLine_2.png")
