...
small_img_path  = os.path.join(test_images_dir, "NavMap_MapTiles_Opacity_60_DefaultOpacity.png")
...
location = pyautogui.locateOnScreen(os.path.join(test_images_dir, "MapMenu_MapTiles.png"), confidence=0.85)
...
if location:
    ...
    # Locate the image on screen
    location = pyautogui.locateOnScreen(os.path.join(test_images_dir, "MapMenu_MapTiles_Opacity.png"), confidence=0.85)
    ...
    if location:
        ...
        # Locate the image on screen
        location = pyautogui.locateOnScreen(os.path.join(test_images_dir, "MapMenu_MapTiles_Opacity_0.png"), confidence=0.85)
        ...
        if location:
            ...
            # Wait for Nav Map with 0% Opacity and user to observe
            time.sleep(3)

        else:
            out.write("Menu item 'MapMenu->MapTiles->Opacity->0' not found.\n")
            # Close the application and terminate execution
            app.close
            sys.exit()

    else:
        out.write("Menu item 'MapMenu->MapTiles->Opacity' not found.\n")
        # Close the application and terminate execution
        app.close
        sys.exit()

else:
    out.write("Menu item 'MapMenu->MapTiles' not found.\n")
    # Close the application and terminate execution
    app.close
    sys.exit()
...
# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_MapTiles_Opacity_0.png")
...
if location:
    ...
    if location:
        ...
        # Locate the image on screen
        location = pyautogui.locateOnScreen(os.path.join(test_images_dir, "MapMenu_MapTiles_Opacity_20.png"), confidence=0.85)
        ...
        if location:
            ...
            # Wait for Nav Map with 20% Opacity and user to observe
            time.sleep(3)

        else:
            out.write("Menu item 'MapMenu->MapTiles->Opacity->20' not found.\n")
            # Close the application and terminate execution
            app.close
            sys.exit()
...
# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_MapTiles_Opacity_20.png")
...
if location:
    ...
    if location:
        ...
        # Locate the image on screen
        location = pyautogui.locateOnScreen(os.path.join(test_images_dir, "MapMenu_MapTiles_Opacity_40.png"), confidence=0.85)
        ...
        if location:
            ...
            # Wait for Nav Map with 40% Opacity and user to observe
            time.sleep(3)

        else:
            out.write("Menu item 'MapMenu->MapTiles->Opacity->40' not found.\n")
            # Close the application and terminate execution
            app.close
            sys.exit()
...
# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_MapTiles_Opacity_40.png")
...
if location:
    ...
    if location:
        ...
        # Locate the image on screen
        location = pyautogui.locateOnScreen(os.path.join(test_images_dir, "MapMenu_MapTiles_Opacity_60.png"), confidence=0.85)
        ...
        if location:
            ...
            # Wait for Nav Map with 60% Opacity and user to observe
            time.sleep(3)

        else:
            out.write("Menu item 'MapMenu->MapTiles->Opacity->60' not found.\n")
            # Close the application and terminate execution
            app.close
            sys.exit()
...
if location:
    ...
    if location:
        ...
        # Locate the image on screen
        location = pyautogui.locateOnScreen(os.path.join(test_images_dir, "MapMenu_MapTiles_Opacity_80.png"), confidence=0.85)
        ...
        if location:
            ...
            # Wait for Nav Map with 80% Opacity and user to observe
            time.sleep(3)

        else:
            out.write("Menu item 'MapMenu->MapTiles->Opacity->80' not found.\n")
            # Close the application and terminate execution
            app.close
            sys.exit()
...
# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_MapTiles_Opacity_80.png")
...
if location:
    ...
    if location:
        ...
        # Locate the image on screen
        location = pyautogui.locateOnScreen(os.path.join(test_images_dir, "MapMenu_MapTiles_Opacity_100.png"), confidence=0.85)
        ...
        if location:
            ...
            # Wait for Nav Map with 100% Opacity and user to observe
            time.sleep(3)

        else:
            out.write("Menu item 'MapMenu->MapTiles->Opacity->100' not found.\n")
            # Close the application and terminate execution
            app.close
            sys.exit()
...
# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_MapTiles_Opacity_100.png")
