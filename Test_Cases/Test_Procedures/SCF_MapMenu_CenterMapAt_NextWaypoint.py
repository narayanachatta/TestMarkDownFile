...
if location:
    ...
    # Locate the image on screen
    location = pyautogui.locateOnScreen(os.path.join(test_images_dir, "MapMenu_CenterMapAt_FirstWaypoint.png"), confidence=0.85)
    ...
    if location:
        ...
        # Wait for Nav Map to update location and user to observe
        time.sleep(3)

    else:
        out.write("Menu item 'MapMenu->CenterMapAt->FirstWaypoint' not found.\n")
        # Close the application and terminate execution
        app.close
        sys.exit()
...
if location:
    ...
    # Locate the image on screen
    location = pyautogui.locateOnScreen(os.path.join(test_images_dir, "MapMenu_CenterMapAt_NextWaypoint.png"), confidence=0.85)
    ...
    if location:
        ...
        out.write("Menu item 'MapMenu->CenterMapAt->NextWaypoint' not found.\n")
        # Close the application and terminate execution
        app.close
        sys.exit()
...
# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_CenterMapAt_NextWaypoint_1.png")
...
# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_CenterMapAt_NextWaypoint_2.png")
...
# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_CenterMapAt_NextWaypoint_3.png")
