...
if location:
    ...
    # Locate the image on screen
    location = pyautogui.locateOnScreen(os.path.join(test_images_dir, "MapMenu_Measure_Line.png"), confidence=0.85)
    ...
    if location:
        ...
        # Wait for Measure Line to appear on Nav Map when a mouse is moved and user to observe
        time.sleep(3)

    else:
        out.write("Menu item 'MapMenu->Measure->Line' not found.\n")
        # Close the application and terminate execution
        app.close
        sys.exit()
...
# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_Measure_Line_1.png")
...
(moved_x, moved_y) = move.move_cursor_to_map_xy(-2000, 0)
...
# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_Measure_Line_2.png")
...
# Wait for the Measure line to cancel
time.sleep(1)

# Move to the ending point
(moved_x, moved_y) = move.move_cursor_to_map_xy(739, 774)

# Perform Measure Line with shortcut keyboard
keyboard.send("l")

# Move to the ending point
(moved_x, moved_y) = move.move_cursor_to_map_xy(1493, -511)

# Wait for the Measure Line to appear on Nav Map and user to observe
time.sleep(3)
...
# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_Measure_Line_3.png")
