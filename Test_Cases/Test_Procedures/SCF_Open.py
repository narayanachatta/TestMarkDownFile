...
if len(good_matches) > 10:
    ...
    if M is not None:    
        ...
        out.write('![Test Image](../Test_Images/UpdateRate_Window.png "Test Image for comparing results")\n')
        #out.write(f"Figure1: Test Image for comparing results\n")
        out.write('![Result Image captured](../Result_Images/matched_region_highlighted.png "Results Image captured to compare with Test Image")\n')
