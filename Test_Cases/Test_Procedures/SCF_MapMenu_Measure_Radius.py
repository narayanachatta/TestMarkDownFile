...
location = pyautogui.locateOnScreen(os.path.join(test_images_dir, "MapMenu_Measure.png"), confidence=0.85)
...
if location:
    ...
    # Locate the image on screen
    location = pyautogui.locateOnScreen(os.path.join(test_images_dir, "MapMenu_Measure_Radius.png"), confidence=0.85)
    ...
    if location:
        ...
        # Wait for Measure Radius to appear on Nav Map when a mouse is moved and user to observe
        time.sleep(3)

    else:
        out.write("Menu item 'MapMenu->Measure->Radius' not found.\n")
        # Close the application and terminate execution
        app.close
        sys.exit()

else:
    out.write("Menu item 'MapMenu->Measure' not found.\n")
    # Close the application and terminate execution
    app.close
    sys.exit()
...
# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_Measure_Radius_1.png")
...
(moved_x, moved_y) = move.move_cursor_to_map_xy(1000, 0)
...
# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_Measure_Radius_2.png")
...
# Cancel the existing Measure line
keyboard.press_and_release("esc")

# Wait for the Measure Radius to cancel
time.sleep(1)

# Move to the ending point
(moved_x, moved_y) = move.move_cursor_to_map_xy(739, 774)

# Perform Measure Radius with shortcut keyboard
keyboard.send("m")

# Move to the ending point
(moved_x, moved_y) = move.move_cursor_to_map_xy(1493, -511)

# Wait for the Measure Radius to appear on Nav Map and user to observe
time.sleep(3)
...
# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_Measure_Radius_3.png")
...
# Cancel the existing Measure Radius
keyboard.press_and_release("esc")
