...
(moved_x, moved_y) = move.move_cursor_to_map_xy(1383, 197)

# Right click on Map
mouse.right_click(coords = (moved_x, moved_y))
...
if location:
    ...
    # Locate the image on screen
    location = pyautogui.locateOnScreen(os.path.join(test_images_dir, "MapMenu_TemporaryMarker_New.png"), confidence=0.85)
    ...
    if location:
        ...
        # Wait for Temporary Marker to appear on Nav Map and user to observe
        time.sleep(3)

    else:
        out.write("Menu item 'MapMenu->TemporaryMarker->New' not found.\n")
...
small_img_path  = os.path.join(test_images_dir, "NavMap_TemporaryMarker_New_1.png")
...
if location:
    ...
    # Locate the image on screen
    location = pyautogui.locateOnScreen(os.path.join(test_images_dir, "MapMenu_TemporaryMarker_Clear.png"), confidence=0.85)
    ...
    if location:
        ...
        out.write("Menu item 'MapMenu->TemporaryMarker->Clear' not found.\n")
        # Close the application and terminate execution
        app.close
        sys.exit()
...
# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_No_TemporaryMarker.png")
