...
# Press X on keyboard to set map center at last waypoint
keyboard.send("x")

# Wait for map to center at last waypoint
time.sleep(1)
...
if location:
    ...
    # Locate the image on screen
    location = pyautogui.locateOnScreen(os.path.join(test_images_dir, "MapMenu_CenterMapAt_PreviousWaypoint.png"), confidence=0.85)
    ...
    if location:
        ...
        out.write("Menu item 'MapMenu->CenterMapAt->PreviousWaypoint' not found.\n")
        # Close the application and terminate execution
        app.close
        sys.exit()
...
# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_CenterMapAt_PreviousWaypoint_1.png")
...
# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_CenterMapAt_PreviousWaypoint_2.png")
...
# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_CenterMapAt_PreviousWaypoint_3.png")
