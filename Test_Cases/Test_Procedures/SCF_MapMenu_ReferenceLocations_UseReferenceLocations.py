...
small_img_path  = os.path.join(test_images_dir, "NavMap_UseReferenceLocations.png")
...
if location:
    ...
    if location:
        ...
        # Wait for the default Home reference location to disappear and user to observe
        time.sleep(3)
...
# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_No_UseReferenceLocations.png")
