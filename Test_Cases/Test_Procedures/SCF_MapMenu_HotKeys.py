...
location = pyautogui.locateOnScreen(os.path.join(test_images_dir, "MapMenu_HotKeys.png"), confidence=0.85)
...
if location:
    ...
    out.write("Menu item 'MapMenu->HotKeys' not found.\n")
...
small_img_path  = os.path.join(test_images_dir, "NavMap_HotKeys.png")
