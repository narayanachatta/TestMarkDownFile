...
if location:
    ...
    # Locate the image on screen
    location = pyautogui.locateOnScreen(os.path.join(test_images_dir, "MapMenu_CenterMapAt_Waypoints.png"), confidence=0.85)
    ...
    if location:
        ...
        out.write("Menu item 'MapMenu->CenterMapAt->Waypoints' not found.\n")
        # Close the application and terminate execution
        app.close
        sys.exit()
...
# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_CenterMapAt_Waypoints.png")
...
(moved_x, moved_y) = move.move_cursor_to_map_xy(-2500, 0)
