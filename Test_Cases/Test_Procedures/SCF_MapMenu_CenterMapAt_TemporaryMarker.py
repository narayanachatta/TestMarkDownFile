...
# Locate the image on screen
location = pyautogui.locateOnScreen(os.path.join(test_images_dir, "MapMenu_CenterMapAt.png"), confidence=0.85)
...
if location:
    ...
    # Locate the image on screen
    location = pyautogui.locateOnScreen(os.path.join(test_images_dir, "MapMenu_CenterMapAt_UAV.png"), confidence=0.85)
    ...
    if location:
        ...
        # Wait for Nav Map to default location and user to observe
        time.sleep(3)

    else:
        out.write("Menu item 'MapMenu->CenterMapAt->UAV' not found.\n")
        # Close the application and terminate execution
        app.close
        sys.exit()

else:
    out.write("Menu item 'MapMenu->CenterMapAt' not found.\n")
    # Close the application and terminate execution
    app.close
    sys.exit()
...
small_img_path  = os.path.join(test_images_dir, "NavMap_HomeUAV_DefaultLocation_TemporaryMarker.png")
...
if location:
    ...
    # Locate the image on screen
    location = pyautogui.locateOnScreen(os.path.join(test_images_dir, "MapMenu_CenterMapAt_TemporayMarker.png"), confidence=0.85)
    ...
    if location:
        ...
        # Wait for Temporary Marker to appear at center on Nav Map and user to observe
        time.sleep(5)

    else:
        out.write("Menu item 'MapMenu->CenterMapAt->TemporayMarker' not found.\n")
        # Close the application and terminate execution
        app.close
        sys.exit()
...
# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_CenterMapAt_TemporayMarker.png")
