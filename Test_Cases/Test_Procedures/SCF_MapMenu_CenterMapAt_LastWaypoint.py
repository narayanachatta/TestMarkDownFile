...
small_img_path  = os.path.join(test_images_dir, "NavMap_HomeUAV_LocationChanged_6.png")
...
if location:
    ...
    # Locate the image on screen
    location = pyautogui.locateOnScreen(os.path.join(test_images_dir, "MapMenu_CenterMapAt_LastWaypoint.png"), confidence=0.85)
    ...
    if location:
        ...
        out.write("Menu item 'MapMenu->CenterMapAt->LastWaypoint' not found.\n")
        # Close the application and terminate execution
        app.close
        sys.exit()
...
# Extract file path of original and small images
original_img_path = os.path.join(original_img_folder, "SCFlight_Window.png")
small_img_path  = os.path.join(test_images_dir, "NavMap_CenterMapAt_LastWaypoint(ERP).png")
